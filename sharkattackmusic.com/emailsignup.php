...
if (isset($_POST) && count($_POST)) { 
  ...
  if (!isset($_POST['list_name']) || empty($_POST['list_name'])) { 
    ...
    if ($listbaby_status == 'bademail') { 
      ...
      header('Location: /emailsignup-thanks.php'); 
      exit; 
    } 
...
<p class='error'>We need more info: Name</p>

<? } elseif ($noemail) { ?> 

<p class='error'>We need more info: Email Address</p>  

<? } elseif ($nocity) { ?> 

<p class='error'>You forgot: City (we'll let you about shows in your area)</p>

<? } elseif ($nostate) { ?> 

<p class='error'>You forgot: State (we'll let you about shows in your area)</p> 

<? } elseif ($nokeyword) { ?> 

<p class='error'>What would you like to receive emails about?</p> 

<? } elseif ($bademail) { ?> 

<p class='error'>Your email address looks wrong, it needs to be in the format: you@yourisp.com</p> 
...
<span <?= $nokeyword ? 'class="error"' : '' ?>>* Tell me about:</span>
<input type="checkbox" name="list_keywords[]" value="srk"<? if (isset($list_keywords) && in_array('srk', $list_keywords)) { echo ('checked="true"'); } ?>>SharkAttack! News
<input type="checkbox" name="list_keywords[]" value="charlene"<? if (isset($list_keywords) && in_array('charlene', $list_keywords)) { echo ('checked="true"'); } ?>>Charlene <br>
<input type="checkbox" name="list_keywords[]" value="compass"<? if (isset($list_keywords) && in_array('compass', $list_keywords)) { echo ('checked="true"'); } ?>>Compass 
<input type="checkbox" name="list_keywords[]" value="lockgroove"<? if (isset($list_keywords) && in_array('lockgroove', $list_keywords)) { echo ('checked="true"'); } ?>>Lockgroove
<? if (isset($list_keywords) && in_array('myspace', $list_keywords)) { echo ('<input type="hidden" name="list_keywords[]" value="myspace">'); } ?>
